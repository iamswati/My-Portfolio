...
new_choice = ['Home','About','Internship Experience','Projects', 'Badges & Certificates', 'Resume', 'Contact']
...
choice = st.sidebar.radio("Go to:",('Home','About','Internship Experience','Projects', 'Badges & Certificates', 'Resume', 'Contact'), index=next_clicked)
...
if choice == 'Home':
    ...
    st.markdown("""<h1 style='text-align: left; color: darkblue;'>Hi👋, I'm Swati Gulati 😊</h1>""", unsafe_allow_html=True)
    st.markdown("<h4 style='text-align: left; color: black;'>AI Intern at IBM | Data Analyst | Web Developer | Programmer | Continuous Learner</h1>", unsafe_allow_html=True)
...
#PROJECTS
    ...
    st.markdown("<h3 style='text-align: left; color: black;'>My Portfolio</h3>", unsafe_allow_html=True)
    st.markdown("<div style='text-align: left; color: darkblue;'>Dec 2021</div>", unsafe_allow_html=True)
    st.markdown("""- Used **Streamlit**, an open-source Python app framework, to build a Portfolio
- Used **Heroku**, a container-based cloud **Platform as a Service (PaaS)**, to deploy a Portfolio""")
    st.markdown("[![Foo](https://img.icons8.com/ios-glyphs/35/000000/github.png)](https://github.com/iamswati/My-Portfolio)[![Foo](https://img.icons8.com/color/35/000000/chrome--v1.png)]()")
    st.markdown("---")

    st.markdown("<h3 style='text-align: left; color: black;'>The Sparks Foundation - Intern</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h3 style='text-align: left; color: black;'>Gold Price Prediction</h3>", unsafe_allow_html=True)
...
- **Predict** the GLD (gold) price by splitting the data & evaluating the model""")
    ...
    st.markdown("<h3 style='text-align: left; color: black;'>Haryana Data Analysis</h3>", unsafe_allow_html=True)
...
- This project starts with **Exploratory Data Analysis (EDA)** for the state of Haryana, India. The data contains various features regarding the COVID-19 outbreak like Date, TotalSamples, etc""")
    ...
    st.markdown("<h3 style='text-align: left; color: black;'>Generate Password</h3>", unsafe_allow_html=True)
    ...
    st.markdown("<h3 style='text-align: left; color: black;'>Covid-19 Data Analysis Germany</h3>", unsafe_allow_html=True)
...
- **Modeling** the data with the various models with appropriate feature selection techniques""")
    ...
    st.markdown("<h3 style='text-align: left; color: black;'>Predict The Power Consumption Of Buildings</h3>", unsafe_allow_html=True)
...
#BADGES & CERTIFICATES
elif choice == 'Badges & Certificates':
    st.markdown("<h1 style='text-align: center; color: darkblue;'>Badges & Certificates</h1>", unsafe_allow_html=True)
    st.markdown("<div><h4 style='text-align: left; colour: darkblue;'>Earned several Badges & Certificates from IBM, Udemy, etc.</h4></div>", unsafe_allow_html=True)

    st.markdown("""---""")

    st.markdown("""[![Foo](https://images.credly.com/size/200x200/images/6235075a-ee6b-4f23-ad48-f06c20993fb2/Career_Explorer.png)](https://www.credly.com/earner/earned/badge/4b3a72ba-e060-4be5-9071-ee2471cd3db7)                                                                                                                         [![Foo](https://images.credly.com/size/200x200/images/5ae9bf9e-da6e-4cec-82eb-d2b4cfea9751/Machine_Learning_with_Python.png)](https://www.credly.com/earner/earned/badge/3a197375-1a1b-48ff-9c2a-848931b76a9c)                                                                                                                         [![Foo](https://img-c.udemycdn.com/course/240x135/3780696_8049_7.jpg)](https://www.udemy.com/certificate/UC-250fea4f-970f-4f8e-8e8d-1770c8f109f0/)   """)
    ...
    st.markdown("""[![Foo](https://images.credly.com/size/200x200/images/b5243e36-b05f-426b-994a-87a535f1c217/Build_your_own_chatbot_-_CC_v3.png)](https://www.credly.com/earner/earned/badge/b2349367-3ec3-430f-b7cc-8daa93765c8e)                                                                                                                               [![Foo](https://images.credly.com/size/200x200/images/6599523a-e811-4775-b037-c4c1417b0b4e/Explorations_into_Mindfulness.png)](https://www.credly.com/earner/earned/badge/858666af-3c5d-4aa2-965b-b8c36eea9dcf)                                                                                                                                                [![Foo](https://images.credly.com/size/200x200/images/89e728ec-27f8-49ce-a8ea-2df7768f9594/Agile_Explorer.png)](https://www.credly.com/earner/earned/badge/a9477a0d-0395-4da0-bc34-5a155e74f9bd)""")

    st.markdown("""---""")

    st.markdown("""[![Foo](https://gdm-catalog-fmapi-prod.imgix.net/ProductLogo/8b9fc1fa-bb42-45c6-957b-3b6611c542f1.png?auto=format&ixlib=react-9.0.3)](https://www.hackerrank.com/iamswati13?hr_r=1)                                                                                                                                         [![Foo](https://images.credly.com/size/200x200/images/7ae738cc-d7af-45fd-ad53-3e21666cdeca/Job_Application_Essentials.png)](https://www.credly.com/earner/earned/badge/f69dbed9-485a-423a-9f02-77907a7bbec7)                                                                                                                                                                                    [![Foo](https://www.guvi.in/images/webps/guvi-logo-full.webp)](https://www.guvi.in/verify-certificate?id=62iO0c98911j8kvfY1)""")

    st.markdown("***")
    
    st.markdown("""[![Foo](https://images.credly.com/size/200x200/images/de9471ce-018c-4bf4-af49-5c9c1d488613/Data_Science_Tools.png)](https://www.credly.com/earner/earned/badge/ecb7003b-6858-40ac-b2e1-c8cceb2271b8)                             [![Foo](https://images.credly.com/size/200x200/images/5ca7b236-6105-4154-ba22-c8ae12ec1d8c/Data_Sci_Found_Level_1_-_CC_-_2019.png)](https://www.credly.com/earner/earned/badge/724ca5a7-5a00-412a-ac18-b1730653a3b6)                             [![Foo](https://images.credly.com/size/200x200/images/84ac9eff-b8a2-4683-846b-f59887a73801/Python_101_Data_Science.png)](https://www.credly.com/earner/earned/badge/3f6b8d3a-13de-4995-84ef-8ebfefc22a0a)                             """)

    st.markdown("***")

    st.markdown("""[![Foo](https://images.credly.com/size/200x200/images/ba34cb1c-4344-43f5-9685-55e2e901c0f0/Data_Analysis_using_Python.png)](https://www.credly.com/earner/earned/badge/214b047a-f936-4e73-8a5a-c5114f6043b6)                             [![Foo](https://images.credly.com/size/200x200/images/087eaefb-61a2-426b-ae74-74efca195667/Data_Visualization_Using_Python.png)](https://www.credly.com/earner/earned/badge/52b808f8-0c72-4dc2-b800-67997313aebc)                             [![Foo](https://images.credly.com/size/200x200/images/53caf8cc-b5e9-4424-b4a7-7b069fa13db4/Machine_Learning_with_Python.png)](https://www.credly.com/earner/earned/badge/4bf02298-2f24-4d0f-863d-b1cbd5072ddd)                             """)
...
#RESUME
    ...
    st.markdown("<div><h4 style='text-align: left; colour: darkblue;'>Created Resume with the help of Creddle (<a href='http://resume.creddle.io/resume/4bukqdwr0ei', target='_blank'>Link</a>)</h4></div>", unsafe_allow_html=True)

    st.markdown("<iframe src='https://resume.creddle.io/embed/4bukqdwr0ei' width='850' height='1100' seamless></iframe>", unsafe_allow_html=True)
