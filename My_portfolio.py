...
if choice == 'Home':
    ...
    st.markdown("<h4 style='text-align: center; color: black;'>AI Intern at IBM | Data Analyst | Web Developer | Programmer | Continuous Learner</h1>", unsafe_allow_html=True)
